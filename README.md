...
````markdown
# 🛰️ Datagram Node Setup Guide (Linux/VPS)

> 🪙 **50% of Datagram tokens are reserved for node operators**  
> Run your node and start earning rewards while supporting the network.

---

## 🚀 System Requirements

To ensure stable performance, we recommend the following minimum VPS specifications:
